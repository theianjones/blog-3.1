    ...
    <main className="my-3">
      <section className="my-24">
        ...
        <p className="font-serif mt-12 prose-xl max-w-60 text-gray-600">
          ...
          taking systems and programming computers. I work primarily in Ruby and
          JavaScript but love functional programming languages. I'm currently
          learning Clojure/ClojureScript. One of my hobbies is working on my
          personal knowledge management system. I publish my work in progress
          notes to my digital garden. Go take a look!
        </p>
      </section>
